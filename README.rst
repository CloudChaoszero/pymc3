...
PyMC3 is tested on Python 3.6, 3.7, and 3.8 and depends on _`Theano-PyMC <https://github.com/pymc-devs/Theano-PyMC>`_, NumPy,
SciPy, and Pandas (see -`requirements.txt <https://github.com/pymc-devs/pymc3/blob/master/requirements.txt`_ for version
information).
